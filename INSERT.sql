...
INSERT INTO preset_group(name, owner, is_public) VALUES
    ('HL:A controller mappings for Oculus Quest', 1, TRUE),
...
INSERT INTO preset VALUES -- version, pg_id, authorid, code, is_yanked, date
    ('0.0.1-alpha.1', 1, 1, '{"a_button": "/input/a","b_button": "/button/b"}', FALSE, '2020-12-09 10:23:56'),
    ('1.0.0', 2, 4, '{"bitrate": "5000"}', TRUE, '2020-12-10 11:54:45'),
    ('1.0.1', 2, 3, '{"bitrate": "5000000"}', FALSE, '2020-12-10 22:04:00'),
    ('0.0.1-alpha.2', 3, 2, '{"a_button": "/input/b","b_button": "/button/a"}', FALSE, '2020-12-10 17:00:07');

-- Message
INSERT INTO public.message(author, pg_id, is_deleted, text) VALUES
    (2, 1, FALSE, 'Is this preset suitable for a GTX 1070? I tried to launch the game after applying it but it seems a bit fuzzy...'),
    (1, 2, FALSE, 'The preset will be updated ASAP since some critical issues have been found'),
    (1, 1, FALSE, 'It is but you should lower the resolution, that GPU may be not enough for this game (which is particularly demanding, btw)'),
    (2, 2, TRUE, 'When will be this preset updated? Since two or three days, after the last patch for the game, my pc crashes whenever I start it :thumbsdown:'),
    (2, 3, FALSE, '@zarik5 Hello admin, can you publish this preset?');

-- Notification
INSERT INTO notification(userid, text, is_read) VALUES
    (3, 'Got a new message!', TRUE),
...
INSERT INTO friend_with VALUES
    (4, 3, TRUE),
    (2, 3, FALSE),
    (2, 1, TRUE); -- Kernel_panic asked friendship with the admin zarik5 to upload an update to a preset
...
INSERT INTO u_owns_g VALUES -- userid, game, install_path
    ...
    (2, 'Half-life: Alyx','C:\Users\Zarik\Games\HLA'),
    (3, 'Subnautica','E:\Users\Kernel_Panic\Program_Files\Games\Subn'),
    (4, 'Google Earth VR', 'D:\Users\Kernel_Panic\Pogram_Files\Games\GE VR');
...
INSERT INTO r_contains_s VALUES -- release version, settingid
    ...
    ('14.0.0-beta.1',3),
    ('14.0.0-beta.1',4),
    ('14.0.0-beta.1',6); -- both releases contains many settings, equals or different from each other
...
INSERT INTO translated_in VALUES -- language, p_version, pg_id, description
    ('eng','0.0.1-alpha.1',1,'This is the first alpha release for the Half-Life:Alyx controller mappings for Oculus Quest'),
    ('eng','1.0.0',2,'Performance settings for the router ASUS RT1200'),
    ('eng','1.0.1',2,'Performance settings for the router ASUS RT1200. Changelog: the preset has been updated for ALVR 14.0.0-beta.1'),
    ('eng','0.0.1-alpha.2',3,'This is the second alpha release for the Half-Life:Alyx controller mappings for Oculus Quest'),
    ('ita','0.0.1-alpha.2',3,'Quest e'' la seconda versione alpha per la mappa dei controlli del visore Oculus Quest per il gioco Half-Life:Alyx');
